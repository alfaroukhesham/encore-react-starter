// Code generated by the Encore v1.43.7 client generator. DO NOT EDIT.
...
export namespace api {
  ...
  export class ServiceClient {
    ...
    public async get(): Promise<CounterResponse> {
      ...
      const resp = await this.baseClient.callAPI("GET", `/counter`);
      return (await resp.json()) as CounterResponse;
    }

    public async increment(): Promise<CounterResponse> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callAPI("POST", `/counter`);
      return (await resp.json()) as CounterResponse;
    }
  }
}
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === "undefined") {
      this.headers["User-Agent"] =
        "cms-react-encore-i4h2-Generated-TS-Client (Encore/v1.43.7)";
    }
